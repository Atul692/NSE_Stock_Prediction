...
company = input("Enter your Company Symbol: ")
print(company)
...
test_end = dt.datetime(2021,2,25)
...
#Plot the predicated values
plt.plot(actual_prices, color="black", label=f"Actual {company} Price")
plt.plot(prediction_prices, color="green", label=f"Predicated {company} Price")
